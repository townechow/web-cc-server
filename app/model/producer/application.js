...
module.exports = app => {
  ...
  const AppSchema = new Schema({
    app_domain: { type: String }, // 应用 域名
    app_name: { type: String }, // 应用名称
    app_id: { type: String }, // 应用appId标识
    ...
    is_statisi_app: { type: Number, default: 0 }, // 是否存储用户应用信息资源信息 0：是   1：否
  ...
  AppSchema.index({ app_id: -1, create_time: 1, app_domain: -1, user_id: -1 });

  return conn.model('Application', AppSchema);
};
