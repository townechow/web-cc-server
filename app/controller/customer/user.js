...
class UserController extends Controller {
  ...
  async login() {
    ...
    const result = await ctx.service.customer.user.login(userName, passWord);
  ...
  async register() {
    ...
    const result = await ctx.service.customer.user.register(userName, passWord);
  ...
  async logout() {
    ...
    await ctx.service.customer.user.logout(usertoken);
  ...
  async getUserList() {
    ...
    const result = await ctx.service.customer.user.getUserList(pageNo, pageSize, userName);
  ...
  async setIsUse() {
    ...
    const result = await ctx.service.customer.user.setIsUse(id, isUse, usertoken);
  ...
  async delete() {
    ...
    const result = await ctx.service.customer.user.delete(id, usertoken);
  ...
  async githubLogin() {
    ...
    try {
      ...
      if (!userResult.data.login || !userResult.data.node_id) {
        ...
        result = await ctx.service.customer.user.githubRegister(userResult.data.login, userResult.data.node_id);
      }
      result.type = 'github';
      await ctx.render('github', {
        data: {
  ...
  async weiboLogin() {
    ...
    try {
      ...
      if (!getUserInfo.data.name || !getUserInfo.data.idstr) {
        ...
        result = await ctx.service.customer.user.githubRegister(getUserInfo.data.name, getUserInfo.data.idstr);
      }
      result.type = 'weibo';
      await ctx.render('github', {
        data: {
  ...
  async wechatLogin() {
    ...
    try {
      ...
      if (!getUserMsg.data.nickname || !getUserMsg.data.openid) {
        ...
        result = await ctx.service.customer.user.githubRegister(getUserMsg.data.nickname, getUserMsg.data.openid);
      }
      result.type = 'wechat';
      await ctx.render('github', {
        data: {
